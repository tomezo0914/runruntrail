...
if ( post_password_required()) : ?>
	<p><?php _e('Enter password to view comments.', 'zeeFlow_language'); ?></p>
<?php return; endif; ?>
...
<?php if ( have_comments() or comments_open() ) : ?>
	...
	<div id="comments">
		...
		<?php if ( have_comments() ) : ?>
			...
			<h3 class="comments-title"><span><?php comments_number( '', __('One comment','zeeFlow_language'), __('% comments','zeeFlow_language') );?></span></h3>
