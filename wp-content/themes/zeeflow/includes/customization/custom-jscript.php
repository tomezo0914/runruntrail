...
function themezee_custom_jscript_navigation() { 
	...
	$params = array(
		'menuTitle' => __('Menu', 'zeeFlow_language')
	);
...
function themezee_custom_jscript_posts() { 
	...
	// Set Parameters array
	$params = array(
		'loadMoreText' => __('Load More Posts', 'zeeFlow_language'),
		'loadingText' => __('Loading posts...', 'zeeFlow_language'),
		'noMoreText' => __('No more posts to load.', 'zeeFlow_language'),
		'startPage' => $paged,
		'maxPages' => $max,
